...
#define NUM_AVERAGES (0)
#define SHUNT_CONV_TIME (4)
#define BUS_CONV_TIME (4)
 ...
 */
#define REG_MAX_EXP_CURRENT ((float)16.384)

#define CURRENT_LSB (REG_MAX_EXP_CURRENT / ((float) 32768))

#define POWER_LSB (CURRENT_LSB * REG_POWER_LSB_RATIO)
